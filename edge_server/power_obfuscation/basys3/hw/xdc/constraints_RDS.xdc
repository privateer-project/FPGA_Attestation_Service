...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { reset_n_in }]; #IO_L24N_T3_RS0_15 Sch=sw[0]

#set_property PACKAGE_PIN J15 [get_ports reset_n_in]
